                ...
                <div className="row g-5">
                    <div className="col-md-5 col-lg-4 order-md-last"><br></br><br></br>
                        <h4 className="d-flex justify-content-between align-items-center mb-3">
                            <span className="display-6 paymentDetails">Order summary</span>
                        ...
                        <br></br>
                        <NavLink to='/success' className="btn btn-dark btn-lg w-100 navlink Continuecheckout" type="submit">Continue to checkout</NavLink><br></br>
                        <NavLink to='/products' className="btn btn-outline-dark btn-lg w-100 navlink backShopping" type="submit">Back Shopping</NavLink>
                    </div>
                    <div className="col-md-7 col-lg-8">
                        <h4 className="display-5 paymentDetails">Enter your payment detail</h4><br></br>
